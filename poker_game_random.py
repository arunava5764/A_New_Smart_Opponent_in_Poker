...
class Poker_Game:
    def __init__(self):
        ...
        self.deck1= Deck()
        self.bind=None
        self.tableCards=[ Card() for i in range(6) ]
        self.pot=None
        self.action=None
        self.bet=None
        self.rational=None
    ...
    def computerAction(self,playerNum):
...
# =============================================================================
    ...
    def printWinningHand(self,winner):
        ...
        print("  | {} | | {} | | {} | | {} | | {} |".format(ranks[winningHand[0].rank] , ranks[winningHand[1].rank] , ranks[winningHand[2].rank] , ranks[winningHand[3].rank] , ranks[winningHand[4].rank]))
        print("  | {} | | {} | | {} | | {} | | {} |".format(suits[winningHand[0].suit] , suits[winningHand[1].suit] , suits[winningHand[2].suit] , suits[winningHand[3].suit] , suits[winningHand[4].suit]))
        print("  |___| |___| |___| |___| |___|")
    ...
    def start(self,name):
        for i in range(6):
            ...
            self.players[i].playing=1000
        self.players[0].name = "Souraj"
        self.players[1].name = "Ayush"
        self.players[2].name = "Ranbir"
        self.players[3].name = "kartik"
...
# =============================================================================
        ...
        print("    / {}            {}            {}" .format("@" if self.bind==0 else " ", "@" if self.bind==1 else " " , "@" if self.bind==2 else " " ), "\\")
        print("   /  ___   ___   ___   ___   ___  \\")
        ...
        print("   | | {} | | {} | | {} | | {} | | {} |" .format(ranks[self.tableCards[0].rank] if (self.tableCards[0].rank)>=0 else " ", ranks[self.tableCards[1].rank] if (self.tableCards[1].rank)>=0 else " ", ranks[self.tableCards[2].rank] if (self.tableCards[2].rank)>=0 else " ",ranks[self.tableCards[3].rank] if (self.tableCards[3].rank)>=0 else " ", ranks[self.tableCards[4].rank] if (self.tableCards[4].rank)>=0 else " ") , "|")
        print("   | | {} | | {} | | {} | | {} | | {} |".format(suits[self.tableCards[0].suit] if (self.tableCards[0].rank)>=0 else " ", suits[self.tableCards[1].suit] if (self.tableCards[1].rank)>=0 else " " , suits[self.tableCards[2].suit] if (self.tableCards[2].rank)>=0 else " " ,suits[self.tableCards[3].suit] if (self.tableCards[3].rank)>=0 else " ", suits[self.tableCards[4].suit] if (self.tableCards[4].rank)>=0 else " "), "|")
        print("   | |___| |___| |___| |___| |___| |")
        print("   |                               |")
# =============================================================================
...
# =============================================================================
        ...
        if (self.players[4].round1):
            ...
            print("   | {} |  | {} |".format(ranks[self.players[4].cards[0].rank] ,ranks[self.players[4].cards[1].rank]))
            print("   | {} |  | {} |".format(suits[self.players[4].cards[0].suit]  , suits[self.players[4].cards[1].suit]))
            print("   |___|  |___|")
