...
class Poker_Game:
            ...
            for k in range(self.bind+1,self.bind+7): 
                ...
                if (k%6==4 and self.players[4].round1):
                    if (self.betOn):
                        ...
                        self.action=int(input("Your action: (1) FLOP (2) CHECK (3) BET/CALL: "))
    ...
    def start(self,name):
        ...
        self.players[2].name = "puneet"
        self.players[3].name = "ashu"
        self.players[4].name = name
        self.players[5].name = "Soarez"
        self.startGame()
...
# =============================================================================
        print("   $",self.players[0].money if self.players[0].playing else 0 , "         $" , self.players[1].money if self.players[1].playing else 0,"           $" ,self.players[2].money if self.players[2].playing else 0)
